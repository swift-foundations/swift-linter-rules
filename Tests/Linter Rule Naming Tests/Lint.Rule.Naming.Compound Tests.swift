...
extension Lint.Rule.Naming.Compound.Test {
    static func findings(in source: String, file: String = "test.swift") -> [Diagnostic.Record] {
        ...
        return Lint.Rule.Naming.Compound().findings(in: parsed)
    }
}

extension Lint.Rule.Naming.Compound.Test.Unit {
    @Test
    func `func openWrite is flagged`() {
        let source = "func openWrite() {}"
        let findings = Lint.Rule.Naming.Compound.Test.findings(in: source)
...
extension Lint.Rule.Naming.Compound.Test.`Edge Case` {
    @Test
